...
[![Travis-CI Build Status](https://travis-ci.org/augustobrusaca/KHQ.svg?branch=master)](https://travis-ci.org/augustobrusaca/KHQ)
<!-- badges: end -->
...
Of note - the package is not yet released on CRAN, download directly from GitHub, option below.
